...
public class Sprint1OnlinePlantNurseryApplication {
	...
	private ApiInfo apiInfo() {
	    return new ApiInfo(
	      "Online Plant Nursery: Seed", 
	      "API for Seed module", 
	      "1.0", 
	      "https://www.google.com/", 
	      new Contact("Shubham Nagmoti", "https://www.google.com/", "shubhamnagmoti0609@gmail.com"), 
	      "License of API", "http://www.apache.org/licenses/LICENSE-2.0", Collections.emptyList());
	}
	
	//http://localhost:9191/onlineplantnursery/swagger-ui
}
