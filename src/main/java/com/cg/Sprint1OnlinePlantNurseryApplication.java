...
public class Sprint1OnlinePlantNurseryApplication {
	...
	private ApiInfo apiInfo() {
	    return new ApiInfo(
	      "Online Plant Nursery: Customer", 
	      "API for Customer module", 
	      "1.0", 
	      "https://www.google.com/", 
	      new Contact("Kantu Pavan Kumar", "https://www.google.com/", "kantupavankumar@gmail.com"), 
	      "License of API", "http://www.apache.org/licenses/LICENSE-2.0", Collections.emptyList());
	}
	//http://localhost:9999/OnlinePlantNursery/swagger-ui/index.html
